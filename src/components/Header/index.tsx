    ...
    <Link href="/wishlist" className="lg:hidden flex items-center">
      <span className="inline-block relative">
        ...
        {wishlistItems.length > 0 && (
          <span className="flex items-center justify-center font-medium text-[8px] absolute -right-1.5 -top-1.5 bg-blue w-3.5 h-3.5 rounded-full text-white">
              ...
              <nav>
                <ul className="flex xl:items-center flex-col xl:flex-row gap-5 xl:gap-6">
                  ...
                  <li className="xl:hidden">
                    <Link href="/wishlist" className="hover:text-blue text-custom-sm font-medium text-dark flex items-center gap-2">
